...
-- includes for all projects
      ...
      configuration "Debug"
         defines { "DEBUG", "_FILE_OFFSET_BITS=64", "_LARGEFILE_SOURCE", "_REENTRANT", "ENV_UNIX", "BREAK_HANDLER", "UNICODE", "_UNICODE", "UNIX_USE_WIN_FILE", "ZSTD_MULTITHREAD", "NO_XXHASH", "FL2_7ZIP_BUILD" }
         flags { "Symbols" }

      configuration "Release"
         defines { "NDEBUG", "_FILE_OFFSET_BITS=64", "_LARGEFILE_SOURCE", "_REENTRANT", "ENV_UNIX", "BREAK_HANDLER", "UNICODE", "_UNICODE", "UNIX_USE_WIN_FILE", "ZSTD_MULTITHREAD", "NO_XXHASH", "FL2_7ZIP_BUILD" }
         flags { "Optimize" }    
